...
where employee_id is an employees ID number, name is their name, months is the total number of months they have been working for the company, and salary is their monthly salary.
